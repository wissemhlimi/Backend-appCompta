...
class TenantRepository {
  ...
  static async destroy(id, options: IRepositoryOptions) {
    ...
    await Client(options.database).deleteMany({ tenant: id }, options);

    await Fournisseur(options.database).deleteMany({ tenant: id }, options);

    await Societe(options.database).deleteMany({ tenant: id }, options);

    await Cabinet(options.database).deleteMany({ tenant: id }, options);

    await Taxes(options.database).deleteMany({ tenant: id }, options);

    await Vente(options.database).deleteMany({ tenant: id }, options);

    await Tva(options.database).deleteMany({ tenant: id }, options);

    await Achats(options.database).deleteMany({ tenant: id }, options);

    await Avoir(options.database).deleteMany({ tenant: id }, options);

    await Activity(options.database).deleteMany({ tenant: id }, options);
